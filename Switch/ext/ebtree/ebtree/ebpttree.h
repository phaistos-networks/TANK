...
static forceinline struct ebpt_node *ebpt_insert(struct eb_root *root, struct ebpt_node *new__)
{
	if (sizeof(void *) == 4)
		return (struct ebpt_node *)eb32_insert(root, (struct eb32_node *)new__);
	else
		return (struct ebpt_node *)eb64_insert(root, (struct eb64_node *)new__);
}
...
static forceinline struct ebpt_node *__ebpt_insert(struct eb_root *root, struct ebpt_node *new__)
{
	if (sizeof(void *) == 4)
		return (struct ebpt_node *)__eb32_insert(root, (struct eb32_node *)new__);
	else
		return (struct ebpt_node *)__eb64_insert(root, (struct eb64_node *)new__);
}
